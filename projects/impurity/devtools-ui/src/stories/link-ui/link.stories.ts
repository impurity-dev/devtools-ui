...
storiesOf('Link', module)
  .add('Link with description', () => ({
    ...
    props: {
      link: { url: "www.google.com", label: "Test Label", description: "This link will be a test and you will enjoy that quality.", icon: { image: "https://via.placeholder.com/75x75", alt: "image alt" } }
    }
  }))
